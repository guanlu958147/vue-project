<template>
   <el-form  label-width="80px" size="small" >
        ...
        <div style="margin-left:80px">
            ...
            <el-button type="primary" :disabled="isDisabled" plain>上传</el-button>
        </div>
    </el-form>
</template>
<script>
...
export default {
  ...
  created(){
    ...
    //   this.$refs.cName.value = this.cName
  },
  methods: {
      ...mapActions("movieStore",["createMoviesAsync"]),
    create() {
        // console.log(this.$refs.country.value)
        this.$store.dispatch(
           "movieStore/createMoviesAsync",
           {
